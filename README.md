...
حالا دیگه می‌تونید توی هر اجرا، در صورت تمایل تیک گزینه اضافه شده رو بزنید تا تمام فایل های آرشیو اجراهای قبلی به صورت یکجا حذف شوند. در صورتی که قبلا این مخزن را فورک کرده اید کافی است آن را سینک کنید تا تغییرات جدید برای شما اعمال شود.
